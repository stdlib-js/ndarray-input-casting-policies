...
```javascript
import policies from 'https://cdn.jsdelivr.net/gh/stdlib-js/ndarray-input-casting-policies@v0.1.1-esm/index.mjs';
```

You can also import the following named exports from the package:

```javascript
import { enum } from 'https://cdn.jsdelivr.net/gh/stdlib-js/ndarray-input-casting-policies@v0.1.1-esm/index.mjs';
```
